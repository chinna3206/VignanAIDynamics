...
function header(){
    ...
    <header className="header-area">
      ...
      <div
        ...
        style="background-image: url(assets/images/hello.webp)"
        >
        <div className="container">
            ...
            <div className="col-lg-8">
              <div className="header-hero-content text-center">
                ...
                <p
                  ...
                  data-wow-delay="0.8s"
                  >
                  Wanna learn how to grow your money to become rich? We have made becoming a stock market Guru easy with our AI powered finance advisor - <b>FinAI&DS 🤵🏻</b>
                </p>
                {/* The Modal */}
