          ...
          <div className="footer-widget pb-100">
            <div className="row">
              <div className="col-lg-4 col-md-6 col-sm-8">
                ...
                >
                  <p className="text">
                    We at VignanAIDynamics  aim to make you a stock market Guru easy with our AI powered teaching and financial blogs.
                  </p>
                </div>
              </div>
              ...
              <div className="col-lg-3 col-md-5 col-sm-5">
                ...
                >
                  ...
                  <ul className="contact">
                    <li>chandrikasruthimanepalli@gmail.com</li>
              ...
              <div className="col-lg-12">
                <div className="copyright d-sm-flex justify-content-between">
                  <div className="copyright-content">
                    <p className="text">
                      © <span id="copyright-year"></span> VignanAIDynamics . All rights reserved, Built with ♥ in India
                    </p>
                  </div>
                </div>
              </div>
