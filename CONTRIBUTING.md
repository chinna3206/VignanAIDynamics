...
```bash
git clone https://github.com/<your-github-username>/VignanAIDynamics .git
```
...
- Admin :- Obadya Sinjin
- Contact :- [Email](chandrikasruthimanepalli@gmail.com)
...
1. Navigate to the project's issues section :- [Issues](https://github.com/ayush-that/VignanAIDynamics /issues)
